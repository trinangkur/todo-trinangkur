...
const addTodoItem = (req, res) => {
  const {titleId, text} = querystring.parse(req.body);
...
const toggleItemStatus = (req, res) => {
  const {titleId, itemId} = querystring.parse(req.body);
...
const deleteTodo = (req, res) => {
  const {titleId} = querystring.parse(req.body);
...
const editTitle = (req, res) => {
  const {titleId, titleText} = querystring.parse(req.body);
...
const editItem = (req, res) => {
  const {titleId, itemId, itemText} = querystring.parse(req.body);
