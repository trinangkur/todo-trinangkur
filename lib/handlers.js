...
const serveNotFound = (req, res) => {
  res.writeHead(statusCode.NOT_FOUND, {'Content-Type': 'text/html'});
...
const methodNotAllowed = (req, res) => {
  ...
  res.writeHead(statusCode.METHOD_NOT_ALLOWED);
...
const areIdsPresent = ({titleId, itemId}) => {
